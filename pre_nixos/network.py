...
def secure_ssh(
    ...
    is queued for a reload-or-restart without blocking. The root password
    itself remains usable for console logins.
    """
    ...
    _systemctl(["reload-or-restart", "--no-block", ssh_service])
    log_event(
